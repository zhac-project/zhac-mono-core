...
//
// auth — access control for the REST and WebSocket APIs. Same file as
// zhac-wired-core's, a port of the dual-chip S3's (zhac-net-core main.cpp + rest_ops.cpp): same NVS keys
